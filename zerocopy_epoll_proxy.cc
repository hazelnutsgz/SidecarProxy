...
private:
    ...
    std::unordered_map<int, bool> write_flag;
...
int main(int argc, char const *argv[])
{
    ...
    if (!strcmp(argv[3], "i") && !strcmp(argv[4], "u")) {
        handler.addProxy(atoi(argv[5]), argv[6]);
    } else if (!strcmp(argv[3], "i") && !strcmp(argv[4], "i")){
        handler.addProxy(atoi(argv[5]), argv[6], atoi(argv[7]));
    } else if (!strcmp(argv[3], "u") && !strcmp(argv[4], "i")){
        handler.addProxy(argv[5], argv[6], atoi(argv[7]));
    } else {
